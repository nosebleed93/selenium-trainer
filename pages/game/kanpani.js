...
function KanpaniGame(nutakuPage, gameConfigs) {
  GameEngine.call(this, nutakuPage, gameConfigs);
  this.constructor = KanpaniGame;
  this.type = 'Kanpani Girls';
  this.url =  "http://www.nutaku.com/games/kanpani-girls/play/";
}

KanpaniGame.prototype = Object.create(GameEngine.prototype);

KanpaniGame.prototype.determineLocation = function (context) {
  var clickAction;
...
KanpaniGame.prototype.determineRow = function (context) {
  var clickAction;
...
KanpaniGame.prototype.playStatic = function (context) {
  var cycleCount = 1,
    currentCount = 0,
    deferred = RSVP.defer(),
    driver = this.driver,
...
KanpaniGame.prototype.executeCycle = function (context, locationSelector, levelSelector, cycleCount) {
...
_.merge(KanpaniGame.prototype.click, localClickActions);
_.merge(KanpaniGame.prototype.queries, localQueries);

KanpaniGame.prototype.locations = locations;

module.exports = KanpaniGame;
